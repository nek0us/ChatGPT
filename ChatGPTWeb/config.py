...
class MsgData:
    ...
    def __init__(self,
        ...
        """
         status: operation execution status | 操作执行状态
         msg_type: operation type | 操作类型
         msg_send: message to be sent | 待发送消息
         msg_recv: message to be received | 待接收消息
         conversation_id: conversation id | 会话id
         p_msg_id: context id to be sent | 待发送上下文id
         next_msg_id: context id to be received | 待接收上下文id
